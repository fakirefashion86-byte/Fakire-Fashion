...
export default function DeliveryLoginPage() {
  ...
  return (
    <AuthLayout title="Delivery Login" subtitle="Manage your delivery assignments">
      ...
      <p className="mt-6 text-center text-sm text-ink-secondary">
        ...
        <Link href="/register?role=delivery" className="font-medium text-accent hover:underline">
          Request access
        </Link>
      </p>
    </AuthLayout>
